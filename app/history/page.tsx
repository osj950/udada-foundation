const historyData = [
  { year: "2001", events: ["(사)사랑의 도시락보내기 운동본부 부설 비인가 대안교육기관 운영 개시", "학교밖청소년 교육 및 문화, 심리지원"] },
  { year: "2009", events: ["2009년 2월 2일 법인 분리", "(사) 우다다청소년재단 공식 설립"] },
  { year: "2018", events: ["부산시교육청 학교 밖 청소년 맞춤형 교육지원 사업", "DMZ 도보여행 프로젝트, 기초학력증진프로그램, 청소년문화예술 교육"] },
  { year: "2019", events: ["부산시교육청 학업중단학생 교육 및 학업복귀 지원사업", "서해안 도보여행 프로젝트, 성평등 프로젝트"] },
  { year: "2020", events: ["부산시교육청 학업중단학생 교육 및 학업복귀 지원사업", "기초학력증진, 영어프로젝트, 청소년창작센터", "아름다운가게 나눔사업 공익활동지원사업"] },
  { year: "2021", events: ["부산시교육청 학업중단학생 교육 및 학업복귀 지원사업 진행", "부산시청 학교 밖청소년 급식지원", "부산시 금정구 우다다 작은도서관 개관"] },
];
